...
function add(arr1, arr2) {
    const num1 = arr1.reduce((acc, curr, index) => acc + curr * Math.pow(10, arr1.length - index - 1), 0);
    const num2 = arr2.reduce((acc, curr, index) => acc + curr * Math.pow(10, arr1.length - index - 1), 0);
    const sum = num1 + num2;
