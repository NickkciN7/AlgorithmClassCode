...
const autocompleteTree = new utils_1.TreeNode("*", Array(new utils_1.TreeNode("a", Array(new utils_1.TreeNode("c", Array(new utils_1.TreeNode("e", Array(new utils_1.TreeNode("$"))), new utils_1.TreeNode("n", Array(new utils_1.TreeNode("e", Array(new utils_1.TreeNode("$"))))))), new utils_1.TreeNode("n", Array(new utils_1.TreeNode("d", Array(new utils_1.TreeNode("$"), new utils_1.TreeNode("r", Array(new utils_1.TreeNode("e", Array(new utils_1.TreeNode("w", Array(new utils_1.TreeNode("$"))))))))))))), new utils_1.TreeNode("b", Array(new utils_1.TreeNode("e", Array(new utils_1.TreeNode("a", Array(new utils_1.TreeNode("m", Array(new utils_1.TreeNode("$"))))), new utils_1.TreeNode("e", Array(new utils_1.TreeNode("f", Array(new utils_1.TreeNode("$"))), new utils_1.TreeNode("s", Array(new utils_1.TreeNode("$"))))))))), new utils_1.TreeNode("c", Array(new utils_1.TreeNode("a", Array(new utils_1.TreeNode("t", Array(new utils_1.TreeNode("$"))))), new utils_1.TreeNode("o", Array(new utils_1.TreeNode("w", Array(new utils_1.TreeNode("$"))))), new utils_1.TreeNode("u", Array(new utils_1.TreeNode("t", Array(new utils_1.TreeNode("$")))))))));
...
function findNode(tree, prefix, index) {
...
console.log((_a = findNode(autocompleteTree, "acn", 0)) === null || _a === void 0 ? void 0 : _a.value);
console.log();
console.log("-----------");
console.log();
...
function collectWords(tree, prefix, list) {
    collectWordsHelper(tree, prefix, list, "");
    // collectWordsHelperOptimized(tree, prefix, list, []);
}
function collectWordsHelper(tree, prefix, list, word) {
    if (tree.value === "$") {
...
function candidates(tree, prefix) {
...
function collectWordsHelperOptimized(tree, prefix, list, word) {
    if (tree.value === "$") {
