...
const MetalBar_1 = require("./MetalBar");
...
// You want to bring back as many bars as of the treasure as you can, but your bag can only fit W (will call it maxWeight) bars.
...
function bestValue(bagCapacity, counts, values) {
    let metalBars = [];
