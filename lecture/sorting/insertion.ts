/**
 *
 * Basically takes last element in inner for loop (starts index 1 then gets larger as outer loop increases).
 * Then continuously tests it against value before it and "inserts" into correct place when it finally meets
 * a value smaller than it (cannot continue at this point)
 *
